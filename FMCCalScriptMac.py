...
s = pickle.load(open('/Users/jlesage/Dropbox/Eclipse/FMCCalibration/SDHBlock-5L64-A2.p','rb'))
d = pickle.load(open('/Users/jlesage/Dropbox/Eclipse/FMCCalibration/A2-5L-64-ProbeDelays.p','rb'))
a = pickle.load(open('/Users/jlesage/Dropbox/Eclipse/FMCCalibration/StepBlockCorrections.p','rb'))
...
pickle.dump(D,open('/Users/jlesage/Dropbox/Eclipse/FMCCalibration/SDHblock'+cal+'.p','wb'))
...
D = pickle.load(open('/Users/jlesage/Dropbox/Eclipse/FMCCalibration/SDHblock'+cal+'.p','rb'))
